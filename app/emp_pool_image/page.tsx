...
import { UserPlus, Pencil, Eraser, MoreHorizontal } from "lucide-react"
                ...
                {data.employees.map((emp: emp_type) => (
                    <div className="h-20" key={emp.id}>
                        ...
                        <div className="w-full flex justify-center">                            
                            ...
                            <Link href={`emp_pool_image/${emp.id}`} className="hover:bg-slate-100" > <MoreHorizontal /> </Link>
                        </div>
                    </div>
                ))}
            </div>
                ...
                {data.employees.map((emp: emp_type) => (
                    <li key={emp.id} >
                        <div className="flex">
                            ...
                            <Link href={`emp_pool_image/${emp.id}`} className="hover:font-semibold">{emp.first_name} </Link>
